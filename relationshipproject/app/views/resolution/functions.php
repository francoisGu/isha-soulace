...
function kopa_register_required_plugins() {
    $plugins = array(
        array(
            'name'              => 'Kopa Resolution Shortcodes', // The plugin name
            'slug'              => 'kopa-resolution-shortcodes', // The plugin slug (typically the folder name)
            'source'            => get_template_directory() . '/plugins/kopa-resolution-shortcodes.zip', // The plugin source
