<div class="kopa-content-box tab-content tab-content-1" id="tab-general">
    ...
    <div class="kopa-box-body">
        ...
        <div class="kopa-element-box kopa-theme-options">
            ...
            <div class="clearfix">
                ...
                <textarea class="left" id="kopa_theme_options_top_banner_url" rows="5" name="kopa_theme_options_top_banner_url"><?php echo htmlspecialchars(stripslashes(get_option('kopa_theme_options_top_banner_url'))); ?></textarea>
            </div>
    ...
    <div class="kopa-box-body">
        ...
        <div class="kopa-element-box kopa-theme-options">
            ...
            <input type="text" value="<?php echo get_option('kopa_theme_options_email'); ?>" id="kopa_theme_options_email" name="kopa_theme_options_email">
        </div>
    </div>
    <div class="kopa-box-head">
        <i class="icon-hand-right"></i>
