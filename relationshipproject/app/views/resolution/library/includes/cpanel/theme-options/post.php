    ...
    <div class="kopa-box-body">
        ...
        <div class="kopa-element-box kopa-theme-options">            
            ...
            foreach ($thumbnail_image_status as $value => $label):
                ...
                ?>
                <label  for="<?php echo $thumbnail_image_id; ?>" class="kopa-label-for-radio-button"><input type="radio" value="<?php echo $value; ?>" id="<?php echo $thumbnail_image_id; ?>" name="<?php echo $thumbnail_image; ?>" <?php echo ($value == get_option($thumbnail_image, 'show')) ? 'checked="checked"' : ''; ?>><?php echo $label; ?></label>
                <?php
            endforeach
            ?>
        </div>
        ...
        <div class="kopa-element-box kopa-theme-options">            
            ...
            foreach ($post_link_status as $value => $label):
                ...
                ?>
                <label  for="<?php echo $post_link_id; ?>" class="kopa-label-for-radio-button"><input type="radio" value="<?php echo $value; ?>" id="<?php echo $post_link_id; ?>" name="<?php echo $post_link; ?>" <?php echo ($value == get_option($post_link, 'show')) ? 'checked="checked"' : ''; ?>><?php echo $label; ?></label>
                <?php
            endforeach
            ?>
        </div>
