...
class kopa_featured_widget extends WP_Widget {
    ...
    function __construct() {
        $widget_ops = array('classname' => 'kp-featured-widget', 'description' => __('Show a post slider and a post list',  kopa_get_domain()));
    ...
    function widget($args, $instance) {
        ...
        if ($big_post->have_posts()):
            ...
            <article class="last-item clearfix">
                <div class="flexslider kp-featured-slider loading" data-animation = "<?php echo $animation; ?>" data-direction = "<?php echo $direction; ?>" data-slideshow-speed = "<?php echo $slideshowSpeed; ?>" data-animation-speed = "<?php echo $animationSpeed; ?>" data-autoplay = "<?php echo $is_Autoplay; ?>">
                    <ul class="slides">
                        <?php
        ...
        <?php
            ...
            $query_args_small['categories'] = $instance['categories'];
            $query_args_small['relation'] = $instance['relation'];
            $query_args_small['tags'] = $instance['tags'];
            $query_args_small['posts_per_page'] = $smallpost;
            $query_args_small['orderby'] = $instance['orderby'];
            $query_args_small['post__not_in'] = $not_in_small;
            
        $small_post = kopa_widget_posttype_build_query($query_args_small);
